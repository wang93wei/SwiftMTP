...
**🌍 言語:** [English](README.md) | [简体中文](docs/README.zh-CN.md) | [日本語](docs/README.ja.md) | [한국어](docs/README.ko.md) | [Русский](docs/README.ru.md) | [Français](docs/README.fr.md) | [Deutsch](docs/README.de.md)
...
| 🌍 **多言語対応** | 簡体字中国語、英語、日本語、韓国語、ロシア語、フランス語、ドイツ語をサポート、システム言語に従う |

## 📸 アプリスクリーンショット

| メイン画面 | ファイル転送 |
|:---:|:---:|
| ![メイン画面](cap_2025-12-24%2005.29.36.png) | ![ファイル転送](cap_2026-02-21%2023.30.24.png) |
...
3. 利用可能な言語：
   ...
   - **日本語** - 日本語インターフェース
   - **한국어** - 韓国語インターフェース
   - **Русский** - ロシア語インターフェース
   - **Français** - フランス語インターフェース
   - **Deutsch** - ドイツ語インターフェース
...
│   │   ├── AppError.swift         # エラー型定義
│   │   └── UpdateInfo.swift       # 更新情報モデル
│   ├── Services/                  # サービスレイヤー
│   │   ├── MTP/                   # MTP サービス
│   │   │   ├── DeviceManager.swift    # デバイス管理
│   │   │   ├── FileSystemManager.swift# ファイルシステム
│   │   │   ├── FileTransferManager.swift # 転送管理
│   │   │   └── FileTransferManager+DirectoryUpload.swift # ディレクトリアップロード拡張
│   │   ├── Protocols/             # プロトコル定義
...
│   │   └── UpdateChecker.swift    # アップデートチェッカー
│   ├── Config/                    # 設定管理
│   │   └── AppConfiguration.swift # アプリケーション設定定数
│   ├── Views/                     # SwiftUI ビュー
│   │   ├── MainWindowView.swift   # メインウィンドウ
│   │   ├── DeviceListView.swift   # デバイスリスト
│   │   ├── FileBrowserView.swift  # ファイルブラウザ
│   │   ├── FileBrowserView+Actions.swift # ファイルブラウザ操作
│   │   ├── FileBrowserView+ToolbarDrop.swift # ファイルブラウザのツールバーとドラッグ&ドロップ
│   │   ├── TableDoubleClickModifier.swift # テーブルダブルクリックブリッジ
...
このプロジェクトは [OpenMTP](https://github.com/ganeshrvel/openmtp) のバックエンドに基づいています。macOS 用の MTP 実装で優れた 작업을された OpenMTP チームに感謝します。
