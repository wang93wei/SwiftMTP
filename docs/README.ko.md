...
**🌍 언어:** [English](README.md) | [简体中文](docs/README.zh-CN.md) | [日本語](docs/README.ja.md) | [한국어](docs/README.ko.md) | [Русский](docs/README.ru.md) | [Français](docs/README.fr.md) | [Deutsch](docs/README.de.md)
...
| 메인 화면 | 파일 전송 |
|:---:|:---:|
| ![메인 화면](cap_2025-12-24%2005.29.36.png) | ![파일 전송](cap_2026-02-21%2023.30.24.png) |
...
│   ├── kalam_*.go                 # 분할된 브리지 모듈 (CGO)
│   ├── *_test.go                  # 모듈별 Go 단위 테스트
...
│   ├── Resources/                 # 리소스 파일
│   │   ├── libkalam.dylib         # Go 동적 라이브러리 (CGO 브리지)
...
4. Liquid Glass UI 구현이 불완전하고 버그가 있어 수정이 필요합니다
5. 코드베이스 개선을 도와줄 많은 기여자를 환영합니다
